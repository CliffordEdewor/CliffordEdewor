...
![Cloud Security](https://img.shields.io/badge/Cloud_Security-Protection-lightgrey)
![Wireshark](https://img.shields.io/badge/Wireshark-Network_Analysis-2C8EBB)
...
#### 🎓 Education & Training
![Cybersecurity Instructor](https://img.shields.io/badge/Cybersecurity-Instructor-purple)
![Mentorship](https://img.shields.io/badge/Mentorship-Leadership-orange)

---

### 📂 Featured Projects

### 🔹 [Strands Agents on Bedrock AgentCore](https://github.com/CliffordEdewor/Strands-Agents-Bedrock-AgentCore)
Hands-on implementation of secure Agentic AI agents using Amazon Bedrock AgentCore, Strands framework, MCP Gateway, Cognito JWT authentication, Docker deployment, and full CloudWatch GenAI observability.
...
- Delivered hands-on **cybersecurity training** under **NITDA’s 3MTT Programme**, enabling **~20% of participants** to achieve internationally recognised industry certifications **(ISC2 CC, CompTIA Security+)**, with others progressing into entry-level roles and receiving national recognition.
